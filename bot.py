...
QUESTIONS = [
    {
        ...
        "options": [
            ...
            ("B. В голове пусто и я напрягаюсь, хотя в быту такого нет", "T2"),
...
RESULTS = {
    "T1": (
        ...
        "под ваши ситуации. Как убрать эту задержку в вашем случае, разберём на вводной консультации.."
    ),
    "T2": (
...
CTA_TEXT = (
    "\n\n—\n"
    "Это короткая диагностика и она показывает направление. "
